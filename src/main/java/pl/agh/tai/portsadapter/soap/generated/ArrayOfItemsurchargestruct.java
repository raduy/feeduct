...
public class ArrayOfItemsurchargestruct  implements java.io.Serializable {
    private pl.agh.tai.portsadapter.soap.generated.ItemSurchargeStruct[] item;

    public ArrayOfItemsurchargestruct() {
    }

    public ArrayOfItemsurchargestruct(
           pl.agh.tai.portsadapter.soap.generated.ItemSurchargeStruct[] item) {
           this.item = item;
    }
     ...
     * @return item
     */
    public pl.agh.tai.portsadapter.soap.generated.ItemSurchargeStruct[] getItem() {
        return item;
    }
     ...
     * @param item
     */
    public void setItem(pl.agh.tai.portsadapter.soap.generated.ItemSurchargeStruct[] item) {
        this.item = item;
    }

    public pl.agh.tai.portsadapter.soap.generated.ItemSurchargeStruct getItem(int i) {
        return this.item[i];
    }

    public void setItem(int i, pl.agh.tai.portsadapter.soap.generated.ItemSurchargeStruct _value) {
        this.item[i] = _value;
    }

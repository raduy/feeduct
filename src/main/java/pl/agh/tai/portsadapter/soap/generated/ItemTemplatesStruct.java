...
public class ItemTemplatesStruct  implements java.io.Serializable {
    private pl.agh.tai.portsadapter.soap.generated.ArrayOfItemtemplateliststruct itemTemplateList;

    private pl.agh.tai.portsadapter.soap.generated.ArrayOfInt itemTemplateIncorrectIds;

    public ItemTemplatesStruct() {
    }

    public ItemTemplatesStruct(
           pl.agh.tai.portsadapter.soap.generated.ArrayOfItemtemplateliststruct itemTemplateList,
           pl.agh.tai.portsadapter.soap.generated.ArrayOfInt itemTemplateIncorrectIds) {
     ...
     */
    public pl.agh.tai.portsadapter.soap.generated.ArrayOfItemtemplateliststruct getItemTemplateList() {
        return itemTemplateList;
    }
     ...
     */
    public void setItemTemplateList(pl.agh.tai.portsadapter.soap.generated.ArrayOfItemtemplateliststruct itemTemplateList) {
        this.itemTemplateList = itemTemplateList;
    }
     ...
     */
    public pl.agh.tai.portsadapter.soap.generated.ArrayOfInt getItemTemplateIncorrectIds() {
        return itemTemplateIncorrectIds;
    }
     ...
     */
    public void setItemTemplateIncorrectIds(pl.agh.tai.portsadapter.soap.generated.ArrayOfInt itemTemplateIncorrectIds) {
        this.itemTemplateIncorrectIds = itemTemplateIncorrectIds;
    }

...
public class DoMyBillingItemResponse  implements java.io.Serializable {
    private pl.agh.tai.portsadapter.soap.generated.ArrayOfItembilling entryFees;

    private pl.agh.tai.portsadapter.soap.generated.ArrayOfItembilling endingFees;

    public DoMyBillingItemResponse() {
    }

    public DoMyBillingItemResponse(
           pl.agh.tai.portsadapter.soap.generated.ArrayOfItembilling entryFees,
           pl.agh.tai.portsadapter.soap.generated.ArrayOfItembilling endingFees) {
     ...
     * @return entryFees
     */
    public pl.agh.tai.portsadapter.soap.generated.ArrayOfItembilling getEntryFees() {
        return entryFees;
    }
     ...
     * @param entryFees
     */
    public void setEntryFees(pl.agh.tai.portsadapter.soap.generated.ArrayOfItembilling entryFees) {
        this.entryFees = entryFees;
    }
     ...
     * @return endingFees
     */
    public pl.agh.tai.portsadapter.soap.generated.ArrayOfItembilling getEndingFees() {
        return endingFees;
    }
     ...
     * @param endingFees
     */
    public void setEndingFees(pl.agh.tai.portsadapter.soap.generated.ArrayOfItembilling endingFees) {
        this.endingFees = endingFees;
    }

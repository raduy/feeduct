...
public class ArrayOfSellratingdetailstruct  implements java.io.Serializable {
    private pl.agh.tai.portsadapter.soap.generated.SellRatingDetailStruct[] item;

    public ArrayOfSellratingdetailstruct() {
    }

    public ArrayOfSellratingdetailstruct(
           pl.agh.tai.portsadapter.soap.generated.SellRatingDetailStruct[] item) {
           this.item = item;
    }
     ...
     * @return item
     */
    public pl.agh.tai.portsadapter.soap.generated.SellRatingDetailStruct[] getItem() {
        return item;
    }
     ...
     * @param item
     */
    public void setItem(pl.agh.tai.portsadapter.soap.generated.SellRatingDetailStruct[] item) {
        this.item = item;
    }

    public pl.agh.tai.portsadapter.soap.generated.SellRatingDetailStruct getItem(int i) {
        return this.item[i];
    }

    public void setItem(int i, pl.agh.tai.portsadapter.soap.generated.SellRatingDetailStruct _value) {
        this.item[i] = _value;
    }

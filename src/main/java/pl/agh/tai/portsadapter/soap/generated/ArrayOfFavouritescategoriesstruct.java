...
public class ArrayOfFavouritescategoriesstruct  implements java.io.Serializable {
    private pl.agh.tai.portsadapter.soap.generated.FavouritesCategoriesStruct[] item;

    public ArrayOfFavouritescategoriesstruct() {
    }

    public ArrayOfFavouritescategoriesstruct(
           pl.agh.tai.portsadapter.soap.generated.FavouritesCategoriesStruct[] item) {
           this.item = item;
    }
     ...
     * @return item
     */
    public pl.agh.tai.portsadapter.soap.generated.FavouritesCategoriesStruct[] getItem() {
        return item;
    }
     ...
     * @param item
     */
    public void setItem(pl.agh.tai.portsadapter.soap.generated.FavouritesCategoriesStruct[] item) {
        this.item = item;
    }

    public pl.agh.tai.portsadapter.soap.generated.FavouritesCategoriesStruct getItem(int i) {
        return this.item[i];
    }

    public void setItem(int i, pl.agh.tai.portsadapter.soap.generated.FavouritesCategoriesStruct _value) {
        this.item[i] = _value;
    }

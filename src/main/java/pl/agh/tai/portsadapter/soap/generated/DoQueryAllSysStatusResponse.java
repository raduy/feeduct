...
public class DoQueryAllSysStatusResponse  implements java.io.Serializable {
    private pl.agh.tai.portsadapter.soap.generated.ArrayOfSysstatustype sysCountryStatus;

    public DoQueryAllSysStatusResponse() {
    }

    public DoQueryAllSysStatusResponse(
           pl.agh.tai.portsadapter.soap.generated.ArrayOfSysstatustype sysCountryStatus) {
     ...
     */
    public pl.agh.tai.portsadapter.soap.generated.ArrayOfSysstatustype getSysCountryStatus() {
        return sysCountryStatus;
    }
     ...
     */
    public void setSysCountryStatus(pl.agh.tai.portsadapter.soap.generated.ArrayOfSysstatustype sysCountryStatus) {
        this.sysCountryStatus = sysCountryStatus;
    }
